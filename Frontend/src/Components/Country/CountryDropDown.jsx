...
const CountryDropDown = ({ vistorsSelections, setVistorsSelections }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4">
      <input type="text" onChange={handleChange} value={vistorsSelections.Country} placeholder="Enter country" className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"/>
